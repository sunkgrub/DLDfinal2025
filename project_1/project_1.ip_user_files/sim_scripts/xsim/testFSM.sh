...
#
# Script generated by Vivado on Tue Dec 09 10:51:09 -0500 2025
...
#
# Usage        : testFSM.sh
#                testFSM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testFSM.sh [-reset_run]
#                testFSM.sh [-reset_log]
#                testFSM.sh [-help]
#
...
# script info
echo -e "testFSM.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testFSM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot testFSM xil_defaultlib.testFSM xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testFSM -key {Behavioral:sim_1:Functional:testFSM} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinix/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testFSM.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./testFSM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: testFSM.sh [-help]\n\
Usage: testFSM.sh [-step]\n\
Usage: testFSM.sh [-lib_map_path]\n\
Usage: testFSM.sh [-reset_run]\n\
Usage: testFSM.sh [-reset_log]\n\
Usage: testFSM.sh [-keep_index]\n\
Usage: testFSM.sh [-noclean_files]\n\n\
